...
export default function AnimatedTetrahedron() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // leave a margin so rotating corners don't get clipped
      const margin = Math.min(rect.width, rect.height) * 0.12
      const centerX = rect.width / 2
      const centerY = rect.height / 2
      const scale = Math.min(rect.width - margin * 2, rect.height - margin * 2) * 0.45
